...
class UserAdmin(object):
    ...
    list_display = ('id', 'username', 'xm', 'gender', 'cardid', 'email', 'nation', 'phone', 'address', 'grade', 'time', 'student_department')
    list_filter = ('username', 'xm', 'gender', 'nation', 'phone', 'email', 'student_department', 'grade')
    search_fields = ('username', 'xm', 'phone', 'email', 'grade')
    ordering = ('username',)
